...
void mul_method1(int **&m1, int **&m2, int **&m3, int m1index[], int m2index[], int m3index[]){
	...
	*/
	...
	if( m1_dim1<8 || m2_dim2<8/* size<10 */ ){
		printf("-------1-------\n");
		printf("%d %d %d\n",m1_dim1,m2_dim2,co_dim);
		printf("m1:\n");
		for(int i=0;i<4;i++)	printf("%d ",m1index[i]);
		printf("\nm2:\n");
		for(int i=0;i<4;i++)	printf("%d ",m2index[i]);
		printf("\nm3:\n");
		for(int i=0;i<4;i++)	printf("%d ",m3index[i]);
		printf("\n");
		...
		next_end2[0] = m1index[0]+(m1index[3]-m1index[2])/2;
		...
		printf("st1:\n");
		for(int i=0;i<4;i++)	printf("%d ",next_st1[i]);
		printf("\nend1:\n");
		for(int i=0;i<4;i++)	printf("%d ",next_end1[i]);
		printf("\nst2:\n");
		for(int i=0;i<4;i++)	printf("%d ",next_st2[i]);
		printf("\nend2:\n");
		for(int i=0;i<4;i++)	printf("%d ",next_end2[i]);
		printf("\n");
